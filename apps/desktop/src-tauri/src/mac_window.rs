// This plugin do two things on macOS:
// 1. Make the title bar transparent
// 2. Position the traffic lights to the desired position
//
// References:
// - https://github.com/tauri-apps/tauri/issues/4789#issuecomment-2016691850
// - https://gist.github.com/charrondev/43150e940bd2771b1ea88256d491c7a9
// - https://github.com/hoppscotch/hoppscotch/blob/a16402e94d9bb1e753296210b9c337e92cc666d0/packages/hoppscotch-selfhost-desktop/src-tauri/Cargo.toml
...
pub fn init<R: Runtime>() -> TauriPlugin<R> {
  Builder::new("mac_window")
    .on_window_ready(|_window| {
      #[cfg(target_os = "macos")]
      window::setup_mac_window(_window);
    })
    .build()
}
...
pub mod window {
  ...
  fn set_transparent_titlebar(ns_window_handle: UnsafeWindowHandle) {
  ...
  pub fn setup_mac_window<R: Runtime>(window: Window<R>) {
    use cocoa::appkit::NSWindow;
    ...
    set_transparent_titlebar(ns_window_handle.clone());

    // Do the initial positioning
    position_traffic_lights(ns_window_handle, WINDOW_CONTROL_PAD_X, WINDOW_CONTROL_PAD_Y);
